			...
			<div class="col-xs-12 col-md-12 col-lg-12">
				<div class="panel panel-default">
					...
					<?php if(isset($_POST['new'])||isset($_POST['edit'])){?>
						<?php
						if($this->session->userdata("position_id")==5&&$invspayment_status==""){
							$show="display:inline;";
					...
					<?php if($uploadinvspaymentpicture_name!=""){$display="display:block;";}else{$display="display:none;";}?>
						...
						<div class="">							
							...
							<div id="collapse4" class="body table-responsive">				
						  	...
						  	<div class="lead"><h3>Charge Item</h3></div>
							<div class="box">
								<div id="collapse4" class="body table-responsive">				
								<table id="" class="table table-condensed table-hover">
									<thead>
									...
									<tbody> 
										...
										<tr class="<?=$bmerah;?>">
											...
											<td style="padding-left:0px; padding-right:0px;">	 
												...
												<?php if($this->session->userdata("position_id")==5&&isset($_GET['invs_no'])&&$_GET['invs_no']!=""){?>		 
												<form method="POST" class="col-md-3" style="padding:0px;">
												...
												<?php if(($this->session->userdata("position_id")==5||$this->session->userdata("position_id")==7)&&$invspayment->invspayment_status=="CA Request"){?>	
												<form method="post" class="col-md-3" style="padding:0px;">
												...
												<?php }?>		
												<?php if($this->session->userdata("position_id")==5&&$invspayment->invspayment_status=="CA Request Approved"){?>	
												<form method="post" class="col-md-3" style="padding:0px;">
												...
												<?php }?>	
												<?php if($this->session->userdata("position_id")==5&&$invspayment->invspayment_status=="CA Out"){?>		
												<form method="post" class="col-md-3" style="padding:0px;">
