...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Sub Parameter</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-md-10">
				<h1 class="page-header"> Sub Parameter</h1>
			</div>
			<?php if(!isset($_POST['new'])&&!isset($_POST['edit'])){?>
			<form method="post" class="col-md-2">							
				<h1 class="page-header col-md-12"> 
				<button name="new" class="btn btn-info btn-block btn-lg" value="OK" style="">New</button>
				<input type="hidden" name="subparameter_id"/>
				</h1>
			</form>
			<?php }?>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12">
				<div class="panel panel-default">
					...
					<?php if(isset($_POST['new'])||isset($_POST['edit'])){?>
						<div class="">
							<?php if(isset($_POST['edit'])){$namabutton='name="change"';$judul="Update Sub Parameter";}else{$namabutton='name="create"';$judul="New Sub Parameter";}?>	
							...
							<div class="form-group">
							  ...
							  <div class="form-group">
								...
								<div class="col-sm-10"> 
								 <select class="form-control" id="equip_id" onChange="parameter()">
								 <option></option>
							  ...
							  <div class="form-group">
								<label class="control-label col-sm-2" for="parameter_id">Parameter :</label>
								<div class="col-sm-10"> 
								 <select class="form-control" id="parameter_id" name="parameter_id">
								 <option></option>
									<?php $param=$this->db->get("parameter");
									foreach($param->result() as $parameter){?>
									<option value="<?=$parameter->parameter_id;?>" <?=$parameter_id==$parameter->parameter_id?"selected":"";?>><?=$parameter->parameter_name;?></option>
									<?php }?>
								  </select>
								</div>
							  </div>
							  <script>
								...
								function parameter(){
									...
									$.get("<?=site_url("parameterid");?>",{equip_id:equip_id})
									.done(function(data){
							  ...
							  <div class="form-group">
								<label class="control-label col-sm-2" for="subparameter_name">Subparameter :</label>
								<div class="col-sm-10">
								  <input type="text" autofocus class="form-control" id="subparameter_name" name="subparameter_name" placeholder="Enter Sub Parameter" value="<?=$subparameter_name;?>">
								</div>
							  </div>
							  ...
							  <input type="hidden" name="subparameter_id" value="<?=$subparameter_id;?>"/>					  					  
							  <div class="form-group"> 
						...
						<?php }else{?>	
							...
							<div class="alert alert-info alert-dismissable">
							  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
							  <strong><?=$message;?></strong><br/><?=$uploadsubparameter_picture;?>
							</div>
							<?php }?>
							<div class="box">
										...
										<tr>
											<td>
												<form method="post">
													...
													<input type="hidden" name="subparameter_id" value="<?=$para->subparameter_id;?>"/>
												</form>											</td>
											<td>
												<form method="post">
