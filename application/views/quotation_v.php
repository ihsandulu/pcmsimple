							...
							-->
									...
									<div class="form-group">
										...
										<div class="col-sm-10"><?= ($customer_name != "") ? $customer_name . "<br/>" : ""; ?>
											...
											<script>
												function pilih(a) {
													$.get("<?= site_url("api/pilihcustomer"); ?>", {
															pilih: a
														})
														.done(function(data) {
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<script>
												ClassicEditor
													.create(document.querySelector('#quotation_statusremarks'))
													.then(editor => {
														editor.setData('<?= $quotation_statusremarks; ?>');
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<script>
												ClassicEditor
													.create(document.querySelector('#quotation_intro'))
													.then(editor => {
														editor.setData('<?= $quotation_intro; ?>');
														editor.ui.view.editable.element.style.height = '120px';
													})
													.catch(error => {
														console.error(error);
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<script>
												ClassicEditor
													.create(document.querySelector('#quotation_workscope'))
													.then(editor => {
														editor.setData('<?= $quotation_workscope; ?>');
														editor.ui.view.editable.element.style.height = '120px';
													})
													.catch(error => {
														console.error(error);
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<script>
												ClassicEditor
													.create(document.querySelector('#quotation_payment'))
													.then(editor => {
														editor.setData('<?= $quotation_payment; ?>');
														editor.ui.view.editable.element.style.height = '120px';
													})
													.catch(error => {
														console.error(error);
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<script>
												ClassicEditor
													.create(document.querySelector('#quotation_closing'))
													.then(editor => {
														editor.setData('<?= $quotation_closing; ?>');
														editor.ui.view.editable.element.style.height = '120px';
													})
													.catch(error => {
														console.error(error);
														...
														<td>
															...
															<script>
																function inputstatus(a, b) {
																	$.get("<?= site_url("api/inputstatus"); ?>", {
																			quotation_status: a.value,
																			quotation_no: b
																		})
																		.done(function(data) {
																			$("#messageisi").html(data);
