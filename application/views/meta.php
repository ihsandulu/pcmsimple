...
<style>
	...
	.ui-datepicker-month,.ui-datepicker-year{border-radius:5px !important; padding:3px !important; border:none !important; margin:3px !important;}
	[data-handler='selectDay']{border-radius:5px !important; border:none !important;}
	.border{border:black solid 1px;}
	body{font-family: 'Source Sans Pro', sans-serif;}
	.iconutama{font-size:30px; position:absolute; left:50%; top:50%; transform:translate(-50%,-50%);}
	@media screen and (min-width: 481px) {
	#judulshow{display:none;}
	}
	@media screen and (max-width: 480px) {
	#judulatas{ font-size:10px !important;}
	#judulshow{display:inline;}
	.judulhide{display:none; text-shadow:white 0 0 10px;}
	#dashboard{margin-top:50px;}
	}
	.parsend{border-bottom:#C9C9C9 solid 1px;}
	button{border-radius:2px !important;}
	input[type=file]{border:none;} 
	input[type=text]background-color:none !important; border:none !important; border-bottom:#AAB9FD solid 1px !important; border-radius:0px !important; box-shadow:none !important;}
	input[type=text]:focus{ background-color:none !important; border:none !important; border-bottom:#AAB9FD solid 2px !important; border-radius:0px !important; box-shadow:none !important;}
	
	.form-group > .control-label{ text-align:left;}
	.backwhite {border-bottom:#F9F9FF solid 1px;}
	.delete{color:red !important;}
	div.dataTables_filter input { background-color:none !important; border:none !important; border-bottom:#F0F0F0 solid 1px !important; border-radius:0px !important; box-shadow:none !important; }
	
	div.dataTables_filter input:focus { background-color:none !important; border:none !important; border-bottom:#F0F0F0 solid 2px !important; border-radius:0px !important; box-shadow:none !important; }
	
	div.dataTables_length select{border:none !important; border-bottom:#F0F0F0 solid 1px !important;  border-radius:0px !important; box-shadow:none !important;}
	.dataTable{border-bottom:#E9E9E9 solid 1px !important;}
	...
	.callout:hover{background: #5CC9DF; color:white !important;}
	.callout.left {	
	...
	.liticketno{	
		background: #A8B9CB; /* For browsers that do not support gradients */
		background: -webkit-linear-gradient(#A8B9CB, #F0F0F0); /* For Safari 5.1 to 6.0 */
		background: -o-linear-gradient(#A8B9CB, #F0F0F0); /* For Opera 11.1 to 12.0 */
		background: -moz-linear-gradient(#A8B9CB, #F0F0F0); /* For Firefox 3.6 to 15 */
		background: linear-gradient(#A8B9CB, #F0F0F0); /* Standard syntax */
	...
	#notification{
		...
		background: linear-gradient(#A7B8CA, #D8DFE7);display:none; 
	}
	#notification::before {
		content: "";
		width: 0px;
	...
	.formnotif1{margin-top:5px;}
	.btnnotif{width:100%; margin-top:-5px;}
	.backungu{	
	...
	.nav.menu>li>ul{ list-style:none;}
	.nav.menu>li>a{ color:#6B7C91 !important;}
	.nav.menu>li{padding:0px !important; margin:0px;}
	...
	.marginkirikanan{margin-left:10px; margin-right:10px;}
	.ellipsis {
	...
	.toggle{display:none;}
	.menufa{margin-right:15px;}
	.border-grey{ border-radius:5px; padding:20px; margin-bottom:15px; box-shadow:#F2F2F2 0px 0px 5px ;}
	.formedit{margin:50px !important; padding:50px !important; border-radius:5px; border:rgba(220,220,220,0.6) solid 1px;}
	.lead{padding:10px !important; background-color:rgba(220,220,220, 0.3); border-radius:5px; border:rgba(220,220,220,0.6) solid 1px; text-align:center; text-shadow:white 1px 1px 1px; box-shadow:rgba(220,220,220, 0.3) 0px 1px 1px 1px}
	.formlead{padding:70px !important; background-color:rgba(240,240,240, 0.3); border-radius:5px; border:rgba(220,220,220,0.6) solid 1px; text-align:center; text-shadow:white 1px 1px 1px;}
	table > thead > tr > th{text-align:center;}
	table > tbody > tr > td{padding:3px; font-size:12px; text-align:center;}
	.sub1{margin-right:10px;}
	.p-1{padding: 5px;}
	.p-2{padding: 10px;}
...
<script>
	...
	funtion bukasub(){$('.sub-item-1').collapse('show');}
