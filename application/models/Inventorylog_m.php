...
class inventorylog_M extends CI_Model {
	...
	{	
		...
		if($this->input->post("create")=="OK"){
			...
			if($this->db->insert_id()>0 && isset($_GET["daurulang"])){
				$this->db->delete($this->input->get("table"),array($this->input->get("table")."_id"=>$this->input->get("id")));
				//echo $this->db->last_query();die();
			}
