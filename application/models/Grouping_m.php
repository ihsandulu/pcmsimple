...
class grouping_M extends CI_Model {
	...
	{	
		...
		if($this->input->post("delete")=="OK"){
			$this->tt->delete("equipment",array("equip_id"=>$this->input->post("equip_id")));
		...
		if($this->input->post("create")=="OK"){
			...
			$this->tt->insert("equipment",$input);
		...
		if($this->input->post("change")=="OK"){
			...
			$this->tt->update("equipment",$input,array("equip_id"=>$this->input->post("equip_id")));
